...
export default function Profile() {
  return (
    <>
      <img
        src="/images/gt.jpeg"
        className="w-[56px] h-[56px] rounded-full object-cover object-center"
      ...
      <div className="flex items-center mt-3 gap-2">
        ...
        <a href={socials.linkedin}>
          ...
          >
            <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2c-1.657 0-2 1.343-2 2v7h-4v-14h4v2.5c.7-1.2 2-2.5 4-2.5z" />
